                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button type="button" class="btn btn-danger mb-2" data-bs-toggle="modal"
                                data-bs-target="#basicModal">Add New JobType</button>
                            <!-- Modal -->
                            <div class="modal fade" id="basicModal">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">New JobType Here!</h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <h4 class="card-title">JobType</h4>
                                                        </div>
                                                        <div class="card-body">
                                ...
                                <table id="example3" class="display" style="min-width: 845px">
                                    ...
                                    <tbody>
                                        @foreach ($JobType as $JobType)
                                            <tr>
                                                <td class="text-center">{{ $JobType->id }}</td>
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex" style="justify-content: center">
                                                        ...
                                                        <form method="POST"
                                                            action="{{ route('JobType.delete', $JobType->id) }}">
                                                            @csrf
