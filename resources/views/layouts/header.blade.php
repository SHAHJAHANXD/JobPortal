                ...
                <div class="dropdown header-profile2 ">
                    <ul class="navbar-nav header-right me-sm-4">
                        <li class="nav-item dropdown notification_dropdown">
                            @if (Auth::user()->role == 'Candidate')
                                <a class="nav-link bell-link " title="Inbox" href="{{ route('candidate.inbox') }}">
                            @endif
                            @if (Auth::user()->role == 'Employer')
                                <a class="nav-link bell-link " title="Inbox" href="{{ route('employer.inbox') }}">
                            @endif
                            @if (Auth::user()->role == 'Admin')
                                <a class="nav-link bell-link " title="Inbox" href="{{ route('admin.inbox') }}">
                            @endif
                    ...
                    <a class="nav-link user-profile" href="javascript:void(0);" role="button"
                        ...
                        <div class="header-info2 d-flex align-items-center">
                            ...
                            @else
                                <img src="{{ asset('dashboard') }}/images/guest.png" alt="">
                            @endif
                    ...
                    <div class="dropdown-menu profile dropdown-menu-end">
                        ...
                        @endif
                        @if (Auth::user()->role == 'Candidate')
                            <a class="dropdown-item ai-icon" title="Inbox" href="{{ route('candidate.inbox') }}">
                        @endif
                        @if (Auth::user()->role == 'Employer')
                            <a class="dropdown-item ai-icon" title="Inbox" href="{{ route('employer.inbox') }}">
                        @endif
                        @if (Auth::user()->role == 'Admin')
                            <a class="dropdown-item ai-icon" title="Inbox" href="{{ route('admin.inbox') }}">
                        @endif
