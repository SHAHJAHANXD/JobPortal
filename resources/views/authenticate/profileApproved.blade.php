                        ...
                        <div class="row m-0">
                            <div class="col-xl-6 col-md-6 sign text-center">
                                <div>
                                    ...
                                    <img src="{{ asset('dashboard') }}/approve.png" class="education-img">
                                </div>
                            </div>
                            <div class="col-xl-6 col-md-6" style="margin-top: auto; margin-bottom: auto">
                                <div class="sign-in-your">
                                    <h3>Dear {{ Auth::user()->first_name }} {{ Auth::user()->last_name }}!</h3>
                                    <p> <i class="fas fa-exclamation" style="color: red;"></i> We are currently
                                        reviewing your details. Your account has not yet been approved. You will receive
                                        a notification via email once your account has been approved. Thank you for your
                                        patience. <i class="fas fa-exclamation" style="color: red;"></i></p>
