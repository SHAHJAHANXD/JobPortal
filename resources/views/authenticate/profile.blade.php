...
Cybinix Job Portal | Admin Profile
@endif
@if (Auth::user()->role == 'Employer')
Cybinix Job Portal | Employer Profile
@endif
@if (Auth::user()->role == 'Candidate')
Cybinix Job Portal | Candidate Profile
@endif
                                                ...
                                                <div class="basic-form">
                                                    <form action="{{ route('candidate.updateProfile') }}" method="POST">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="wa_no"
                                                                value="{{ $userData->wa_no }}">
                                                            @if ($errors->has('wa_no'))
                                                                <span
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div id="about-me" class="tab-pane fade active show">
                                                ...
                                                <div class="profile-personal-info">
                                                    ...
                                                    <div class="row mb-2">
                                                        <div class="col-sm-3 col-5">
                                                            <h5 class="f-w-500">Whatsapp Contact <span
                                                                    class="pull-end">:</span>
                                                            </h5>
                                                        </div>
