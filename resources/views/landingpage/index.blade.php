...
<head>
    ...
    <title>Cybinix Job Portal</title>
...
<body>
                    ...
                    <div class="col-xl-8 col-lg-9 col-md-12">
                        ...
                        <div class="section-tittle section-tittle3 text-center mb-10">
                            ...
                            <p>The automated process starts as soon as your clothes go into the machine. The outcome is
                                gleaming
                                clothes. Placeholder text commonly used.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="top-job-slider ">
                    ...
                    <div class="single-top-jobs ">
                        <div class="services-ion">
                            <img src="assets/img/icon/job-iocn1.svg" alt="">
                        </div>
                    ...
                    <div class="single-top-jobs ">
                        <div class="services-ion">
                            <img src="assets/img/icon/job-iocn2.svg" alt="">
                        </div>
                        <div class="services-cap">
                            <h5><a href="#">Design & creatives</a></h5>
                            <p>The automated process starts as soon as your clothes go into.</p>
                    ...
                    <div class="single-top-jobs ">
                        <div class="services-ion">
                            <img src="assets/img/icon/job-iocn3.svg" alt="">
                        </div>
                        <div class="services-cap">
                            <h5><a href="#">Design & creatives</a></h5>
                            <p>The automated process starts as soon as your clothes go into.</p>
                    ...
                    <div class="single-top-jobs ">
                        <div class="services-ion">
                            <img src="assets/img/icon/job-iocn4.svg" alt="">
                        </div>
                        <div class="services-cap">
                            <h5><a href="#">Design & creatives</a></h5>
                            <p>The automated process starts as soon as your clothes go into.</p>
                    ...
                    <div class="single-top-jobs ">
                        <div class="services-ion">
                            <img src="assets/img/icon/job-iocn5.svg" alt="">
                        </div>
                        <div class="services-cap">
                            <h5><a href="#">Design & creatives</a></h5>
                            <p>The automated process starts as soon as your clothes go into.</p>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat">
                            <div class="cat-icon">
                                <img src="assets/img/icon/top-cat1.svg" alt="">
                            </div>
                            <div class="cat-cap">
                                <h5><a href="#">Design & creatives</a></h5>
                                <p>The automated process starts as soon as your clothes go into.</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat">
                            <div class="cat-icon">
                                <img src="assets/img/icon/top-cat2.svg" alt="">
                            </div>
                            <div class="cat-cap">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat">
                            <div class="cat-icon">
                                <img src="assets/img/icon/top-cat3.svg" alt="">
                            </div>
                            <div class="cat-cap">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat">
                            <div class="cat-icon">
                                <img src="assets/img/icon/top-cat4.svg" alt="">
                            </div>
                            <div class="cat-cap">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat">
                            <div class="cat-icon">
                                <img src="assets/img/icon/top-cat5.svg" alt="">
                            </div>
                            <div class="cat-cap">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat">
                            <div class="cat-icon">
                                <img src="assets/img/icon/top-cat6.svg" alt="">
                            </div>
                            <div class="cat-cap">
        ...
        <div class="testimonial-area">
            <div class="container">
                <div class="testimonial-wrapper">
                    ...
                    <div class="t-shape">
                        <img src="assets/img/gallery/testimonial-shape.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col-xl-12 ">
                                    <div class="footer-copy-right text-center">
                                        <p>Copyright &copy;
                                            ...
                                            made with <i class="fa fa-heart color-danger" aria-hidden="true"></i> by
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vaafb692b2aea4879b33c060e79fe94621666317369993"
        ...
        data-cf-beacon='{"rayId":"7931e0ac3fe6de4b","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2022.11.3","si":100}'
